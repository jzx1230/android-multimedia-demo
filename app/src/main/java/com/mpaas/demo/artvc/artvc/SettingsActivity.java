...
public class SettingsActivity extends AppCompatActivity implements OnSharedPreferenceChangeListener {
  ...
  private String keyprefServerType;
  private String keyprefCustomUid;
  private String keyprefCustomServer;
  private String keyprefVideoSource;
  private String keyprefBizName;
  private String keyprefSubBiz;
  private String keyprefSignature;
  private String keyprefWorksapceId;
  ...
  private String keyprefVideoRecord;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    keyprefServerType = getString( R.string.pref_server_key );
    keyprefCustomUid = getString( R.string.pref_custom_uid_key );
    keyprefCustomServer = getString( R.string.pref_custom_server_key );
    keyprefVideoSource = getString( R.string.pref_video_source_key );
    keyprefBizName = getString( R.string.pref_biz_name_key );
    keyprefSubBiz = getString( R.string.pref_sub_biz_key );
    keyprefSignature = getString( R.string.pref_signature_key );
    keyprefWorksapceId = getString( R.string.pref_workspace_biz_key );
    ...
    keyprefVideoRecord = getString(R.string.pref_video_record_key);
  ...
  protected void onResume() {
    ...
    updateSummary( sharedPreferences, keyprefServerType );
    updateSummary( sharedPreferences, keyprefCustomUid );
    updateSummary( sharedPreferences, keyprefCustomServer );
    updateSummary( sharedPreferences, keyprefVideoSource );
    updateSummary( sharedPreferences, keyprefBizName );
    updateSummary( sharedPreferences, keyprefSubBiz );
    updateSummary( sharedPreferences, keyprefSignature );
    updateSummary( sharedPreferences, keyprefWorksapceId );

    updateSummaryB(sharedPreferences, keyprefVideoRecord);
  ...
  public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
    ...
    if (key.equals(keyprefResolution)
        ...
        || key.equals(keyprefServerType)
        || key.equals(keyprefCustomServer)
        || key.equals(keyprefCustomUid)
        || key.equals(keyprefVideoSource)
        || key.equals(keyprefBizName)
        || key.equals(keyprefSubBiz)
        || key.equals(keyprefSignature)
        || key.equals(keyprefWorksapceId)) {
